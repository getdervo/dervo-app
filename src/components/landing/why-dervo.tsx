  ...
  return (
    <section className="grid items-center gap-12 bg-white px-6 py-16 sm:px-12 lg:grid-cols-[1fr_1.1fr]">
      <Reveal>
        ...
        <StaggerGroup as="ul" className="mt-6 flex flex-col gap-[13px]" stagger={0.09} delayChildren={0.15}>
          {REASONS.map((reason) => (
            <StaggerItem as="li" key={reason} className="flex items-center gap-[11px]" y={14}>
      ...
      <Reveal as="figure" className="m-0 rounded-3xl border border-cardline bg-white px-9 py-[34px] shadow-dervo-md" delay={0.1}>
        <div
          aria-hidden="true"
