  ...
  return (
    <section className="grid gap-13 bg-linear-to-b from-white to-frost px-6 pb-15 pt-13 sm:px-12 lg:grid-cols-[1.05fr_0.95fr]">
      <div className="flex flex-col justify-center">
        ...
        <p className="mt-5 max-w-[470px] text-[17px] leading-[1.65] text-ink">
        ...
        <div className="mt-7.5">
          <Link
            href="/napkin"
            className="inline-block rounded-full bg-royal px-7 py-[15px] text-[15px] font-bold text-frost shadow-dervo-md transition-colors duration-150 hover:bg-royal-dark"
          >
      ...
      <div className="relative">
        ...
        <div className="mt-4 flex flex-col gap-4 md:mt-0 md:block">
          <div className="flex flex-col items-center gap-2 rounded-[20px] bg-white px-[22px] py-[18px] shadow-dervo-lg md:absolute md:top-[26px] md:-left-6">
          ...
          <div className="flex items-center gap-3 rounded-2xl bg-white px-[18px] py-[14px] shadow-dervo-lg md:absolute md:bottom-[30px] md:-left-6">
